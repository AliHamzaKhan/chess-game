...
class FirestoreService extends GetxService {
  ...
  Future<void> updateUserStats(String uid, int pointsChange, bool isWin) async {
      ...
      int newWins = isWin ? currentData.wins + 1 : currentData.wins;
      int newLosses = isWin ? currentData.losses : currentData.losses + 1;
